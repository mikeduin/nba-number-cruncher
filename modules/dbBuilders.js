              ...
              .insert(
                {
                  ...
                  w_pct: player[9],
                  min: player[10],
                  eoff_rating: player[11],
                  off_rating: player[12],
                  sp_work_off_rating: player[13],
                  edef_rating: player[14],
                  def_rating: player[15],
                  sp_work_def_rating: player[16],
                  enet_rating: player[17],
                  net_rating: player[18],
                  sp_work_net_rating: player[19],
                  ast_pct: player[20],
                  ast_to: player[21],
                  ast_ratio: player[22],
                  oreb_pct: player[23],
                  ...
                  epace: player[32],
                  pace: player[33],
                  pace_per40: player[34],
                  sp_work_pace: player[35],
                  pie: player[36],
                  poss: player[37],
                  fgm: player[38],
                  fga: player[39],
                  ...
                  w_rank: player[44],
                  l_rank: player[45],
                  w_pct_rank: player[46],
                  min_rank: player[47],
                  eoff_rating_rank: player[48],
                  off_rating_rank: player[49],
                  sp_work_off_rating_rank: player[50],
                  edef_rating_rank: player[51],
                  def_rating_rank: player[52],
                  sp_work_def_rating_rank: player[53],
                  enet_rating_rank: player[54],
                  net_rating_rank: player[55],
                  sp_work_net_rating_rank: player[56],
                  ast_pct_rank: player[57],
                  ast_to_rank: player[58],
                  ast_ratio_rank: player[59],
                  oreb_pct_rank: player[60],
                  dreb_pct_rank: player[61],
                  reb_pct_rank: player[62],
                  tov_pct_rank: player[63],
                  e_tov_pct_rank: player[64],
                  efg_pct_rank: player[65],
                  ts_pct_rank: player[66],
                  usg_pct_rank: player[67],
                  e_usg_pct_rank: player[68],
                  epace_rank: player[69],
                  pace_rank: player[70],
                  sp_work_pace_rank: player[71],
                  pie_rank: player[72],
                  fgm_rank: player[73],
                  fga_rank: player[74],
                  fgm_pg_rank: player[75],
                  fga_pg_rank: player[76],
                  fg_pct_rank: player[77],
                  cfid: player[78],
                  cfparams: player[79],
                  updated_at: new Date()
                },
