...
module.exports = {
  buildSubData: async (gid) => {
    const pbpUrl = `https://data.nba.com/data/10s/v2015/json/mobile_teams/nba/2020/scores/pbp/00${gid}_full_pbp.json`;
    const gameDetailUrl = `https://data.nba.com/data/10s/v2015/json/mobile_teams/nba/2020/scores/gamedetail/00${gid}_gamedetail.json`;
